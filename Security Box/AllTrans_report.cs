...
{
    public partial class AllTrans_report : Form
    {
        public AllTrans_report()
        {
            InitializeComponent();
        }
        ...
        private void AllTrans_report_Load(object sender, EventArgs e)
        {
        ...
        private void show_btn_Click(object sender, EventArgs e)
        {
            ...
            this.cash_TransactionTableAdapter.FillByAllBetweenDates(this.securityBoxDS.Cash_Transaction, dateTimePicker1.Value.Date, dateTimePicker2.Value.Date);
            fillParameters();
