...
{
    public partial class OutTrans_Report : Form
    {
        public OutTrans_Report()
        {
            InitializeComponent();
        }
        ...
        private void OutTrans_Report_Load(object sender, EventArgs e)
        {
        ...
        private void show_btn_Click(object sender, EventArgs e)
        {
            ...
            this.cash_TransactionTableAdapter.FillByOutBetweenDates(this.securityBoxDS.Cash_Transaction,dateTimePicker1.Value.Date, dateTimePicker2.Value.Date);
            fillParameters();
